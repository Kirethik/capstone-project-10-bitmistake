...
class Model():
    ...
    def save(self, directory):
        ...
        # save the classifier model to a .keras file inside the directory
        keras_model_path = os.path.join(directory, "model.keras")
        self.classifier.model.save(keras_model_path)
    ...
    def load(self, directory):
        ...
        # Load the keras model from the .keras file inside the directory
        keras_model_path = os.path.join(directory, "model.keras")
        self.classifier.model = tf.keras.models.load_model(keras_model_path)
        ...
        self.classifier.loc = np.array(parameters['loc'])
        self.classifier.scale = np.array(parameters['scale'])
