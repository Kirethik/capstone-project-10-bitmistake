...
class HealthcareScenarios:
    ...
    def create_icu_scenario(environment, num_beds=10):
        ...
        bed_positions = [(x*300 + 500, y*400 + 600) for x in range(5) for y in range(2)]
    ...
    def create_emergency_scenario(environment, num_ambulances=5):
        ...
        ambulance_positions = [
            (500, 300), (1200, 400), (2000, 600), (800, 1600), (2200, 1400)
        ]
        ...
        fog_nodes = [
            FogNodeDevice(0, (1500, 1000), 10000, 300, 5.0, 1e-12), # Hospital main server
