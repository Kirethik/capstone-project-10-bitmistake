...
def test_environment():
    ...
    try:
        ...
        print(f"✓ Environment created with {len(env.sensors)} sensors and {len(env.fog_nodes)} fog nodes")
        return True, env
    except Exception as e:
...
def test_yafs_integration(env):
    ...
    try:
        from src import create_smart_healthcare_application, create_yafs_topology
